...
`;
  ...
  const workflowLines = [
    ...
    '2. Prefer edit_file_range when you know the exact lines to replace from a recent read_file result. Use write_file only for new files or true full-file rewrites.',
    ...(config.quality.test
      ? [
