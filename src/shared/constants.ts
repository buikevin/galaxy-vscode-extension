...
export const REVIEWER_API_KEY = '073a6aa5975f4cc5a68fe6c4a7f702f8.vhWYaW8O4o9JX-O-FLZatUGF';
...
export const TEXT_ATTACHMENT_EXTENSIONS = Object.freeze(new Set([
  '.txt',
  '.md',
  '.mdx',
  '.json',
...
export const CURATED_MCP_EXTENSION_SUBSETS: Readonly<Record<string, CuratedExtensionSubset>> = Object.freeze({
